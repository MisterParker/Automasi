    ...
    private void readings(){
        ...
        parentRef.child("MQ2_stats").child("CO").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                Log.i("qwer",String.valueOf(dataSnapshot.getValue()));
        ...
        parentRef.child("temp").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {


                String temp_value = String.valueOf(dataSnapshot.getValue());

                temp.setText("LPG:"+temp_value);
            }
